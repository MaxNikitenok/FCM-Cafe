...
export const OrderReceived = ({ username, goods }) => {
  return (
    <View style={styles.order}>
      <View style={styles.orderInfo}>
        <View style={styles.orderStatus}>
          <Image
            source={require('@/assets/images/received.svg')}
        ...
        <View style={styles.orderDetails}>
          ...
          <View style={styles.orderTelPayment}>
            ...
            <Text style={styles.orderPayment}>Нал, опл.</Text>
          </View>
      ...
      {/* <View style={styles.orderButtons}>
        ...
        <Pressable style={({ pressed }) => [{ opacity: pressed ? 0.5 : 1.0 }]} onPress={() => console.log('button')}>
          <View style={[styles.button, styles.greenButton]}><Text style={styles.greenButtonText}>Выдан</Text></View>
        </Pressable>
      </View> */}
    </View>
  );
